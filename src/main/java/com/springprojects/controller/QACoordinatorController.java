...
public class QACoordinatorController {
    ...
    public @ResponseBody
    Timeline[] mostLikedIdeas_GET(HttpSession session) {
    ...
    public @ResponseBody
    Timeline[] mostCommentedIdeas_GET(HttpSession session) {
    ...
    public @ResponseBody
    Timeline[] mostVisitedIdeas_GET(HttpSession session) {
    ...
    public @ResponseBody
    Timeline[] mostSeenIdeas_GET(HttpSession session) {
