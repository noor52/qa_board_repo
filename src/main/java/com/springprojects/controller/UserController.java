...
public class UserController {
    ...
    public @ResponseBody
    Integer totalNumberOfIdeasByDepartment(HttpSession session,
    ...
    public @ResponseBody
    Integer totalPercentageOfIdeasByDepartment(HttpSession session,
                                               @RequestParam(name = "departmentName", defaultValue = "") String departmentName) {
    ...
    public @ResponseBody
    Integer totalContributionsByDepartment(HttpSession session,
                                           @RequestParam(name = "departmentName", defaultValue = "") String departmentName) {
    ...
    public @ResponseBody
    Integer totalNumberOfIdeasWithoutComment(HttpSession session,
                                             @RequestParam(name = "departmentName", defaultValue = "") String departmentName) {
    ...
    public @ResponseBody
    Integer totalAnonymousComments(HttpSession session,
                                   @RequestParam(name = "departmentName", defaultValue = "") String departmentName) {
